...
if text and text:match('^'..(DevRio:get(Prox..'Rio:NameBot') or "سوريا")..' ') then
data.message_.content_.text_ = data.message_.content_.text_:gsub('^'..(DevRio:get(Prox..'Rio:NameBot') or "سوريا")..' ','')
end
...
if text == '↫ المتجر ♡' then 
if SecondSudo(msg) then 
local Sudo_Welcome = '♡︙اهلا بك مجددا عزيزي المطور \n♡︙اليك الازرار الخاصه بمتجر سورس سوريا فقط اضغط على الامر الذي تريد تنفيذه'
local key = {
{'↫  المتجر ♡'},
...
local ProxTeam = {'- Nothing stops him who wants you .','make them wish they had you !.','Maybe a magical girl','٫ 𝖡𝖾 𝗌𝗂𝗆𝗉𝗅𝖾 𝖺𝗇𝖽 𝖽𝗂𝖿𝖿𝖾𝗋𝖾𝗇𝗍','. 𝖬𝖺𝗄𝖾 𝖽𝗋𝖾𝖺𝗆𝗌 𝖿𝗋𝗈𝗆 𝗒𝗈𝗎𝗋 𝗋𝖾𝖿𝗋𝖺𝖼𝗍𝗂𝗈𝗇𝗌 . .',':Life is lying .','𝖨 𝗐𝗂𝗅𝗅 𝖺𝗅𝗐𝖺𝗒𝗌 𝗅𝗈𝗏𝖾 𝗒𝗈𝗎 𝗇𝖾𝗏𝖾𝗋 𝖿𝗈𝗋𝗀𝖾𝗍'}  
...
if text == "صورتي" or text == "المنشئئ" then
...
sendPhoto(msg.chat_id_, msg.id_, 0, 1, nil, result.photos_[0].sizes_[1].photo_.Manager_id," ♡︙عدد صورك ↫ "..result.total_count_.." صوره‌‏", msg.id_, msg.id_, "md")
else
send(msg.chat_id_, msg.id_,'لا تمتلك صوره في حسابك', 1, 'md')
end end
tdcli_function ({ ID = "GetUserProfilePhotos", Manager_id = msg.sender_user_id_, offset_ = 0, limit_ = 1 }, getpro, nil)
end
--     Source Prox     --
...
local BotName = (DevRio:get(Prox.."Rio:NameBot") or 'سوريا')
...
sudobot = '\n♡︙عدد الجروبات ↫ '..(DevRio:get(Prox..'Rio:Sudos'..result.sender_user_id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n♡︙عدد الجروبات ↫ '..(DevRio:get(Prox..'Rio:Sudos'..res.id_) or 0)..'' 
else 
sudobot = '' 
end
...
sudobot = '\n♡︙عدد الجروبات ↫ '..(DevRio:get(Prox..'Rio:Sudos'..iduser) or 0)..'' 
else 
sudobot = '' 
end
...
Dev_Rio(msg.chat_id_, msg.id_, 1,'♡︙عدد الجروبات الان ↫ { '..#group..' }'..Proxgp1..Proxgp2..'\n♡︙العدد الحقيقي الان  ↫ ( '..Proxgp3..' ) \n ', 1, 'md')
end end
end,nil)
end
return false
...
local ProxTeam = '♡︙اهلا عزيزي ↫ '..RioRank(msg)..' \n♡︙تم تفعيل الميمز'
riomoned(msg.chat_id_, msg.sender_user_id_, msg.id_, ProxTeam, 14, string.len(msg.sender_user_id_))
DevRio:del(Prox..'Rio:memz:Rio'..msg.chat_id_) 
end
...
if text and (text == "ميمز" or text == "↫ ميمز ♡") and not DevRio:get(Prox..'Rio:memz:Rio'..msg.chat_id_) and ChCheck(msg) then
...
if text and (text == "غنيلي" or text == "↫ غنيلي ♡") and not DevRio:get(Prox..'Rio:Audios:Rio'..msg.chat_id_) and ChCheck(msg) then
...
os.execute('wget https://raw.githubusercontent.com/gret7/new/master/Prox.lua') 
dofile('Prox.lua') 
...
DevRio:set(Prox..'Rio:NameBot',(DevRio:get(Prox..'Name:Bot') or 'سوريا'))
end
for i = 1, #Users do
local id = Users[i]
if id:match("^(%d+)") then
...
local GetJson, Res = https.request("https://raw.githubusercontent.com/gret7/newFiles/master/ProxFiles/"..FileName)
if Res == 200 then
